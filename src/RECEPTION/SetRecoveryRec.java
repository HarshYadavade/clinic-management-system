...
public class SetRecoveryRec extends javax.swing.JFrame {
...
//end
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 30, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = ("update rec_reg set question='"+question+"',answer='"+answer+"' where username ='"+recuname+"'");
        ...
        if(rs.next()){
         JOptionPane.showMessageDialog(null, "Recovery Question set Successfully...!");
                                ...
                                JOptionPane.showMessageDialog(null, "Recovery Question not set...!");
                              }
        r.receptionname(recname);
        r.receptionuname(recuname);
        r.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SetRecoveryRec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SetRecoveryRec().setVisible(true);
            }
        });
    }
