...
public class Receptionpass extends javax.swing.JFrame {
...
JOptionPane.showMessageDialog(null , "Password changed Successfully");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Receptionpass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Receptionpass().setVisible(true);
            }
        });
    }
