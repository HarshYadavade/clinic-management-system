...
public class Doctorpass extends javax.swing.JFrame {
...
//end    
    ...
    private void initComponents() {
        ...
        getContentPane().add(uname, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 340, -1, -1));

        name.setFont(new java.awt.Font("Monospaced", 1, 36)); // NOI18N
        getContentPane().add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 350, 570, 50));
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        Doctorportal  mngdr =new Doctorportal();
        String druname = uname.getText();
        String drname = name.getText();
        mngdr.drusername(druname);
        mngdr.drname(drname);
    ...
    String sql= "select password from doctor_reg where username='"+n+"'";
...
JOptionPane.showMessageDialog(null , "Password changed Successfully");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Doctorpass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Doctorpass().setVisible(true);
            }
        });
    }
