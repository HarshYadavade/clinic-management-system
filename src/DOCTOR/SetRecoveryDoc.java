...
public class SetRecoveryDoc extends javax.swing.JFrame {
...
//end
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 30, -1, 40));
        ...
        jTextField2.setToolTipText("*QUESTION FIELD  IS CASE SENSITIVE PLEASE INPUT WITH CARE");
...
//        String sqll 
        ...
        String sql = ("update doctor_reg set question='"+question+"',answer='"+answer+"' where username='"+druname+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SetRecoveryDoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SetRecoveryDoc().setVisible(true);
            }
        });
    }
