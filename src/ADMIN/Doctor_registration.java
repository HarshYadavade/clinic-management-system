...
public class Doctor_registration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setFont(new java.awt.Font("Monospaced", 1, 36)); // NOI18N
        jLabel12.setText("DOCTOR REGISTRATION");
        ...
        getContentPane().add(jScrollPane6, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 430, 270, 30));
        getContentPane().add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 480, 500, 30));

        jComboBox1.setFont(new java.awt.Font("Monospaced", 0, 18)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Male", "Female", "Other" }));
        jComboBox1.setSelectedItem(null);
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 430, 90, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      JOptionPane.showMessageDialog(null, "Empty fields detected ! Please fill up all fields");
            else if(jTextPane6.getText().length()==0)  // Checking for empty field
      JOptionPane.showMessageDialog(null, "Empty fields detected ! Please fill up all fields");
   else{
        ...
        String spl = jTextPane6.getText();
          String sql = "insert into doctor_reg(name,email,contact,address,username,qualifications,password,gender,spl) values (?,?,?,?,?,?,?,?,?)";
            try {
