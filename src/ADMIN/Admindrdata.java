...
public class Admindrdata extends javax.swing.JFrame {
    public Admindrdata() {
        initComponents();
        Refresh();
    }
...
//            
            ...
            JOptionPane.showMessageDialog(null, e);
               ...
               Logger.getLogger(Admindrdata.class.getName()).log(Level.SEVERE, null, ex);
           }
       }
       };
       Refresh.start();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 30, 390, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 30, 100, 30));
        ...
        getContentPane().add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 60, 380, 20));
    ...
    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
        Manage_dr drlist =new Manage_dr();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admindrdata.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admindrdata().setVisible(true);
            }
        });
    }
