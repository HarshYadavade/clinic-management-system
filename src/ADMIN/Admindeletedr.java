...
public class Admindeletedr extends javax.swing.JFrame {
    public Admindeletedr() {
        initComponents();
        Refresh();
    }
    public void Refresh()
...
//            
            ...
            ResultSet rs=st.executeQuery("select name from doctor_reg");
            while(rs.next()){
            ...
            JOptionPane.showMessageDialog(null, e);
               ...
               Logger.getLogger(Admindeletedr.class.getName()).log(Level.SEVERE, null, ex);
           }
       }
       };
       Refresh.start();  
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 540, 120, 40));
        ...
        jLabel21.setFont(new java.awt.Font("Monospaced", 0, 10)); // NOI18N
        jLabel21.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel21.setText("* The list update's after every 1 minute");
        getContentPane().add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 60, 380, 20));
        ...
        jLabel19.setText("CHOOSE DOCTOR");
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 30, 390, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 30, 100, 30));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 30, 100, 30));
    ...
    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
        Manage_dr drdellist =new Manage_dr();
        drdellist.setVisible(true);
        dispose();
        ...
        try{
            ...
            Statement stmt = con.createStatement();
                ...
                if(rs.next()){                    
                    ...
                    jLabel18.setText(rs.getString("spl"));
            }
        }catch(SQLException e){
            JOptionPane.showMessageDialog(null,e);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      try{
            Connection con = Connectionpro.getCon();
            Statement stmt = con.createStatement();
                String sql="delete from doctor_reg where name = '"+ dr_name +"'";
                ResultSet rs = stmt.executeQuery(sql);
                if(rs.next()){                    
                    jLabel12.setText("");
                    jLabel13.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admindeletedr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admindeletedr().setVisible(true);
            }
        });
    }
