...
//end      
       ...
       public void run(){
        try{
            ...
            String patuname = patientusername.getText();
                ...
                String sql = "select * from prescription where pat_username = '"+patuname+"' and date = '"+xyz+"'";
                Connection con= Connectionpro.getCon();          
                Statement stmt = con.createStatement();
                ResultSet rs = stmt.executeQuery(sql);
                while(rs.next()) {
                String medicine =rs.getString("med_name") ;
                String timing =rs.getString("time") ;
                String quantity =rs.getString("quantity") ;
                String data [] = {medicine,timing,quantity};
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 30, -1, 40));
