...
import AMJH_CMS.Patientlogin1;
import Connect.Connectionpro;
import java.sql.*;
import javax.swing.JOptionPane;

public class CP_pat extends javax.swing.JFrame {

public void pusername(String uname){
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 20, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        catch (SQLException e)
        {
            ...
            Patientlogin1 pa = new Patientlogin1();
            pa.setVisible(true);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CP_pat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
