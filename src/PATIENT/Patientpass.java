...
public class Patientpass extends javax.swing.JFrame {
...
//end
    ...
    private void initComponents() {
        ...
        getContentPane().add(patientusername, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 420, 100, 40));

        patientname.setFont(new java.awt.Font("Monospaced", 1, 36)); // NOI18N
        getContentPane().add(patientname, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 330, 580, 40));
    ...
    String n = patientusername.getText();
    String old = jPasswordField4.getText();
    String newp = jPasswordField2.getText();
    String cnfnewp = jPasswordField3.getText();  
    String sql= "select password from pat_reg where username='"+n+"'";
    String sqll= "update pat_reg set password ='"+cnfnewp+"'where username='"+n+"'";
    try{
...
JOptionPane.showMessageDialog(null , "Password changed Successfully");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Patientpass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Patientpass().setVisible(true);
            }
        });
    }
